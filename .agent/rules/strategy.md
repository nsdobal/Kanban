...
- Drag and drop interface to move cards between columns and within columns
...
1. Ignore MIT LICENSE file in the project folder
2. Ignore README.md file in the project folder